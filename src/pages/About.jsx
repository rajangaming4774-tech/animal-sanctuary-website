  ...
  return (
    <>
      ...
      <section className="section">
        <div className="wrap grid cols-2" style={{ alignItems: 'center', gap: 48 }}>
          <div>
            ...
            <div className="flex wrap-flex mt-2" style={{ gap: 10 }}>
      ...
      <section className="section" style={{ background: 'linear-gradient(160deg, var(--green-800), var(--green-700))', color: '#fff' }}>
        <div className="wrap grid cols-4">
          {STATS.map((s) => (
            <div className="center" key={s.label}>
              <div style={{
                width: 56, height: 56, borderRadius: 18, margin: '0 auto 14px',
                background: 'rgba(255,255,255,.12)', display: 'grid', placeItems: 'center', color: '#fff',
              }}>
              ...
              <div style={{ color: 'rgba(255,255,255,.7)' }}>{s.label}</div>
            </div>
          ))}
        </div>
      </section>
      ...
      <section className="section">
        <div className="wrap">
          ...
          <div className="grid cols-3">
            {values.map((v) => (
              <div className="box" key={v.title} style={{ textAlign: 'center' }}>
                <span style={{
            ...
            {team.map((t) => (
              <div className="card" key={t.name}>
                ...
                <div style={{ padding: '18px 20px 22px', textAlign: 'center' }}>
                  <h3 style={{ fontSize: '1.1rem', marginBottom: 3 }}>{t.name}</h3>
